				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
            			...
            			<td valign="top" class="headerContainer">
            				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCodeBlock">
	            					...
	            					<tr>
													<td id="header" valign="top" style="max-width: 100%!important;background: #9acb3c;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
														<h1 style="font-family: Roboto;font-size: 36px;font-style: normal;font-weight: bold;text-align: center;margin: 40px auto 40px auto;color: #FFFFFF!important;">¡Tienes una solicitud de costo!</h1>
													</td>
												</tr>     
	    								</tbody>
										</table>
					...
					<tr>
            			...
            			<td valign="top" class="bodyContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCaptionBlock">
            						...
            						<td class="mcnCaptionBlockInner" valign="top" style="padding:9px;">
    												...
    												<tbody>
                										...
                										<tbody>
                        									...
                        									<img alt="" src="https://gallery.mailchimp.com/f5c15284b26fcde7f06fb6724/images/95622704-4668-402a-8584-5d9df7bbc0c7.png" width="264" style="max-width:512px;" class="mcnImage">  
                    										</td>
                											</tr>
												            </tbody>
												          </table>
										                ...
										                <tbody>
										                	<tr>
                    										<td valign="top" class="mcnTextContent" style="font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 200%;">
                        									<span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif"><strong><?php echo $user; ?></strong>&nbsp;creo una solicitud de costo, los detalles de esta solicitud se mostrarán a continuación:</span><br><br>
																					<span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif"><strong>Código del producto:</strong>&nbsp;<br><?php echo $product_code; ?></span><br>
																					<span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif"><strong>Descripción del producto</strong>:<br><?php echo $product_description; ?></span>
                    										</td>
                											</tr>
												            </tbody>
												          </table>
					                ...
					                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 5px;background-color: #9ACB3C;">
				                    <tbody>
			                        <tr>
	                                ...
	                                <a class="mcnButton " title="CREAR COSTO BASE" href="javascript:void(0);" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">CREAR COSTO BASE</a>
		                            </td>
			                        </tr>
				                    </tbody>
					                </table>
				                    ...
				                    <tbody>
				                    	<tr>
                      					<td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">
																	<span style="font-size:16px"><em><strong>Copyright © 2018 C.I. Estrada Velásquez, Todos los derechos reservados.</strong></em></span><br><br>&nbsp;
                      					</td>
                  						</tr>
						                </tbody>
						              </table>
