            						...
            						<td class="mcnCaptionBlockInner" valign="top" style="padding:9px;">
    												...
    												<tbody>
                										...
                										<tbody>
                        									...
                        									<img alt="" src="<?php echo $this->config->item('assets_path').'dist/custom/images/emails/requerimientos/costo_base/rich.png'; ?>" width="264" style="max-width:512px;" class="mcnImage">  
                    										</td>
                											</tr>
												            </tbody>
												          </table>
