        	...
        	<tr>
					...
					<tr>
            			...
            			<td valign="top" class="headerContainer">
            				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCodeBlock">
	            					...
	            					<tr>
													<td id="header" valign="top" style="max-width: 100%!important;background: #c52320;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
														<h1 style="font-family: Roboto;font-size: 36px;font-style: normal;font-weight: bold;text-align: center;margin: 40px auto 40px auto;color: #FFFFFF!important;">¡Tienes una solicitud de plano!</h1>
													</td>
												</tr>     
	    								</tbody>
										</table>
					...
					<tr>
            			...
            			<td valign="top" class="bodyContainer"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnCaptionBlock">
            						...
            						<td class="mcnCaptionBlockInner" valign="top" style="padding:9px;">
    												...
    												<tbody>
										                ...
										                <tbody>
                        									...
                        									<span style="font-family:roboto,helvetica neue,helvetica,arial,sans-serif"><strong><?php echo $user; ?></strong>&nbsp;creo una solicitud de plano, los detalles de esta solicitud se mostrarán a continuación:</span><br><br>
					                ...
					                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 1px none;border-radius: 5px;background-color: #c52320;">
				                    <tbody>
			                        <tr>
	                                ...
	                                <a class="mcnButton " title="CREAR COSTO BASE" href="javascript:void(0);" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">CREAR PLANO</a>
		                            </td>
			                        </tr>
				                    </tbody>
					                </table>
